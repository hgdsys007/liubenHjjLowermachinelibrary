...
public final class VirtualCom4Io {
    private VirtualCom4Io(){}
    private static VirtualCom4Io instance=null;
    public static VirtualCom4Io getInstance()
    {
        if (instance==null)
            instance=new VirtualCom4Io();
        return instance;
    }
    ...
    {
        VirtualTcpOutput.getInstance().wirte(CmdUtil.makeComCmd(CmdUtil.COM4,data));
    }
}
